...
class RoundingErrorSubstituted(object):
    substitutions = {
...
class BinaryIntOperationTests(RoundingErrorSubstituted, BinaryOperationTestCase, TranspileTestCase):
    data_type = 'int'


class InplaceIntOperationTests(RoundingErrorSubstituted, InplaceOperationTestCase, TranspileTestCase):
    data_type = 'int'
